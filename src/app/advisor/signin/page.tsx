...
import { AlertCircle, ArrowRight, Eye, EyeOff, Loader2, Lock, User, Users } from 'lucide-react';
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-surface-base p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mb-7 text-center">
          ...
          <h1 className="text-[22px] font-bold leading-tight text-text-primary">Berater Portal</h1>
          <p className="mt-1.5 text-[13px] leading-relaxed text-text-muted">
            Melden Sie sich an, um Ihre Empfehlungen zu verwalten
          </p>
        </div>
        ...
        {/* Footer */}
        <div className="mt-6 text-center text-xs leading-relaxed text-text-muted">
          <p>Probleme beim Anmelden?</p>
          <p className="mt-1">
            Kontaktieren Sie uns unter{' '}
            <a
              href="mailto:office@4money.at"
