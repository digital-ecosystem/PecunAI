    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="p-3 sm:p-4 lg:p-6">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Neues Produkt hinzufügen</h1>
          <p className="text-sm sm:text-base text-gray-600">Erstellen Sie ein neues Produkt mit KI-Konfiguration</p>
        </div>
