...
export default function Chatbot({
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="flex flex-col h-full max-h-[90vh] w-full max-w-2xl border border-gray-300 rounded-lg bg-white shadow-lg">
        {/* Header */}
        ...
        {/* Input Form */}
        <form onSubmit={handleFormSubmit} className="p-4 border-t border-gray-200 flex-shrink-0">
