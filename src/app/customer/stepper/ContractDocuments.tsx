                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      ...
                      <tr>
                        ...
                        <td className="py-3 px-2 text-gray-700">300,00 €</td>
                      ...
                      <tr>
                        ...
                        <td className="py-3 px-2 text-gray-700">390,00 €</td>
                        <td className="py-3 px-2 text-gray-700">0,24 %</td>
                        <td className="py-3 px-2 text-gray-700">240,00 €</td>
                      </tr>
                      <tr>
                        ...
                        <td className="py-3 px-2 text-gray-700">370,00 €</td>
                        <td className="py-3 px-2 text-gray-700">0,37 %</td>
                        <td className="py-3 px-2 text-gray-700">370,00 €</td>
                      </tr>
                      <tr>
