/*
  ...
  - The values [KONSERVATIV,AUSGEWOHGEN,GEWINNORIENTIERT] on the enum `RiskType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."RiskType_new" AS ENUM ('KONSERVATIV', 'AUSGEWOHGEN', 'GEWINNORIENTIERT');
